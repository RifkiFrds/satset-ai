...
const suggestions = [
  ...
  },
  {
    ...
    prompt: "Review tata bahasa dari paragraf ini: [tempel paragraf Anda di sini]",
  },
];
...
const cardVariants = {
  ...
  animate: (i) => ({
    ...
    y: 0,
    transition: {
      delay: i * 0.1 + 0.3, // Animasi + stagger
      duration: 0.3,
      ease: "easeOut",
    },
  }),
      ...
      ">
        {suggestions.map((item, i) => (
          <motion.button
            ...
            className="
              flex items-center gap-3 p-4 w-full max-w-full
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Batasi baris agar tidak overflow */}
